...
<div class="container-fluid">
    ...
    <header class="container">
        <div class="col-lg-11 text-center">
            <h2>${sessionScope.username}的通话时长（被叫）</h2>
        </div>
        <div class="col-lg-1">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <nav>
                    <ul class="pager">
                        <li><a href="info.jsp">用户主叫次数</a></li>
                        <li><a href="info1.jsp">用户主叫通话时长</a></li>
                        <li><a href="info2.jsp">用户被叫次数</a></li>
                        <li><a href="info3.jsp">用户被叫通话时长</a></li>
