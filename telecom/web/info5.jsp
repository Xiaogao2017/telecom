...
<div class="container-fluid">
    ...
    <header class="container">
        <div class="col-lg-11 text-center">
            <h2>${sessionScope.username}的通话时长（主叫和被叫）</h2>
        </div>
        <div class="col-lg-1">
...
<script>
    //用户的主动通话时长
    var sumDuration_0 = new Array();
    var sumDuration_0_i = 0;
    <c:forEach var="list" items="${sessionScope.sumDuration_0}" >
    sumDuration_0[sumDuration_0_i++] = ${list}
    </c:forEach>
    //用户的通话被叫通话时长
    var sumDuration_1 = new Array();
    var sumDuration_1_i = 0;
    <c:forEach var="list" items="${sessionScope.sumDuration_1}" >
    sumDuration_1[sumDuration_1_i++] = ${list}
    </c:forEach>
    //初始化
